...
<body class="d-flex flex-column">
    ...
    <header class="header-area dfoody-header shadow card border-0">
        ...
        <div class="container">
            <div class="row d-flex justify-content-end mt-5 w-100">
                <div class="col-md-12">
                    ...
                    <div class="csa-text">
                        <h3>Apply now</h3>
                        <p>Here you can apply for your transcript where every you are and when ever you want <br><i>Your confort and safety is our prority</i></p>
                    ...
                    <div class="csa-social">
                        <ul class="footer-social">
                            <li><a href="https://twitter.com/voidcoders"><i class="fa fa-twitter"
                                        aria-hidden="true"></i></a></li>
                            <li><a href="https://www.facebook.com/voidcoders/"><i class="fa fa-facebook"
                                        aria-hidden="true"></i></a></li>
                            <li><a href="https://www.instagram.com/voidcoders/"><i class="fa fa-instagram"
                                        aria-hidden="true"></i></a></li>
                            <li><a href="https://www.linkedin.com/company/voidcoders/about/"><i class="fa fa-linkedin"
                                        aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
                </div>
